function Home() {
    return (
        <div className="h-[700px] flex flex-col items-center justify-center">
            {/* Main Promo Section */}
            <main className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-1 py-6 text-center space-y-4">
                <h1 className="text-4xl md:text-6xl font-bold bg-gradient-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent leading-tight">
                    Build Stunning Dashboards<br className="hidden md:block" /> in Minutes, Not Weeks
                </h1>
                
                <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto">
                    Accelerate your React development with pre-built, customizable components. 
                    Create enterprise-grade dashboards with beautiful design system out of the box.
                </p>
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 w-full">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {/* Downloads Card */}
                    <div className="bg-white/5 border border-white/10 backdrop-blur-lg p-6 rounded-xl shadow-2xl hover:transform hover:-translate-y-2 transition-all duration-300">
